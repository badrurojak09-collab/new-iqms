        ...
        return $schema->components([
            Section::make('Input Data Program Studi')
                ...
                ->schema([
                    ...
                    TextInput::make('nama_prodi')->label('Nama Program Studi')->required()->maxLength(255),
                    ...
                    Select::make('jenjang')->options(['D3' => 'D3', 'D4' => 'D4', 'S1' => 'S1', 'S2' => 'S2', 'S3' => 'S3', 'Profesi' => 'Profesi'])->required(),
